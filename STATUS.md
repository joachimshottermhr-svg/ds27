...
| 3 - components | **23 of 39 component sets** (Progress bar is Single category only) |
...
Breadcrumb, Tab single, Header display, Multi avatar, Content display, Form field, Data display, Step, Step connector.
...
| 2 | Select button elements, User chat bubble, App header + top navigation, workspace header, message box, Attachments, AI assistant overlay (mobile), config tile, Confirmation modal | see inventory |
