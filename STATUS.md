...
| 3 - components | **17 of 39 component sets** (Progress bar is Single category only) |
...
Breadcrumb, Tab single, Header display.
...
| 2 | Multi avatar, Select button elements, Step connector, User chat bubble, App header + top navigation, workspace header, message box, Attachments, AI assistant overlay (mobile), config tile, Confirmation modal | see inventory |
