...
| 3 - components | **20 of 39 component sets** (Progress bar is Single category only) |
...
Breadcrumb, Tab single, Header display, Multi avatar, Content display, Form field.
...
| 2 | Select button elements, Step connector, User chat bubble, App header + top navigation, workspace header, message box, Attachments, AI assistant overlay (mobile), config tile, Confirmation modal | see inventory |
